    ...
    session_start();
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST")
        {
            ...
            if(!empty($iid) && !empty($password) )
            {
                ...
                //read from database
                $query = "select * from insurance where In_Id = '$iid' limit 1";
                 ...
                 <br>
                    ...
                    <form method = "post">
                        <table border=0>
                            ...
                            <tr height="100px">
                                <td width="600px">
                                    <h6 style= "font-family:Aachen BT">&nbsp       &nbspInsurance ID:</h6>
                                 </td>
                                 <td width="400px">
                                     <input style= "border:2px solid" type="text" name="IID" placeholder="          Enter Your ID" pattern="[A-Za-z0-9]+" required>
                                 </td>
                            </tr>
                            <tr height="60px">
                                <td>
