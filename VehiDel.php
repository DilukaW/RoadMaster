            ...
            if(!empty($vid) )
                    {
                        ...
                        $query = "UPDATE vehicle SET Driver_Id = NULL WHERE  Vehicle_Id = '$vid' ";
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="section-heading">
                  ...
                  <br>
                  <br>
                    <p>Here's a list of all the vehicles you own. If You want to Delete Details of a Vehicle click 'DELETE'.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="ftco-section">
                              ...
                              <?php
                                ...
                                <td width='100px'>
                                  ...
                                  <span aria-hidden='true'><i class='fa fa-close'></i></span> -->
                                    <input type='hidden' name='Vid' value='{$row['Vehicle_Id']}'>
        ...
        <div class="col-lg-2 offset-lg-9" style=" margin-left: 700px; margin-right: auto;">
                <div class="trainer-item" >
                    <div >
                    <div class="main-button"><a style= " font-family:Aachen BT ; border-color:white; " href="Vehiedit.php">Go Back</a></div>
                    </div>
