    ...
    session_start();
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST")
        {
            ...
            if(!empty($pid) && !empty($password) )
            {
                ...
                //read from database
                $query = "select * from Police where P_Id = '$pid' limit 1";
                ...
                <div class="section-heading">
                    ...
                    <form method = "post">
                        <table border=0>
                            ...
                            <tr height="100px">
                                <td width="600px">
                                    <h6 style= "font-family:Aachen BT" > Police ID:</h6>
                                 </td>
                                 <td width="400px">
                                     <input style= "border:2px solid" type="text" name="PID" placeholder="          Enter Your ID" required>
                                 </td>
                            </tr>
                            <tr height="60px">
                                <td>
