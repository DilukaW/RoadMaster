<?php 
    ...
    session_start();
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST")
        {
            ...
            if(!empty($rid) && !empty($password) )
            {

                //read from database
                $query = "select * from rda where RDA_Id = '$rid' limit 1";
                            ...
                            if($result2)
                            {
                                if($result2 && mysqli_num_rows($result2) > 0)
                                {
                                    ...
                                    if($user_data2['Password'] === $password)
                                    {
                                        ...
                                        $_SESSION['RDA_Id'] = $user_data['RDA_Id'];
                ...
                <div class="section-heading">
                    ...
                    <form method = "post">
                        <table border=0>
                            ...
                            <tr height="100px">
                                <td width="600px">
                                    <h6 style= "font-family:Aachen BT">&nbsp       &nbsp  Insurance ID:</h6>
                                 </td>
                                 <td width="400px">
                                     <input style= "border:2px solid" type="text" name="RID" placeholder="           Enter Your ID" pattern="[A-Za-z0-9]+" required>
                                 </td>
                            </tr>
                            <tr height="60px">
                                <td>
                                    <h6 style= "font-family:Aachen BT">Password:</h6>
                                </td>
                                <td>
